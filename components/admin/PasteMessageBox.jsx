    ...
    try {
      ...
      if (file.name.toLowerCase().endsWith('.zip')) {
        ...
        for (const [name, data] of Object.entries(files)) {
          // استثناء ملفات الماك التلقائية والمجلدات
        ...
        <div className="panelHeader">
          <div className="titleWrap">
            ...
            <div>
              ...
              <p className="subtitle">قم بلصق محادثات الواتساب أو رفع ملفات نصية ومضغوطة (ZIP) ليقوم الذكاء الاصطناعي باستخراج العقارات منها.</p>
            </div>
          </div>
        </div>
